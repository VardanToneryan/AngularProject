...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, NavComponent, HeaderComponent, AllPostsComponent, CommonModule, CategoryComponent, AuthorsComponent,JoinOurTeamComponent,FooterComponent],
